					...
					<header class="major narrow">
                        ...
                        if($_SESSION['user_ses']==1){
                            ...
                            if (!$q->rowCount() == 0) 
                            {
                                ...
                                echo "<td class='text-success' style='font-family:bold'>Appointment</td>";
                                echo "<td class='text-success' style='font-family:bold'>Patient</td>";
                            ...
                            if (!$q->rowCount() == 0) 
                            {
                                ...
                                echo"<tr>";
                                echo "<td>".$results['name']."</td>";
                                echo "<td>".$results['appoint']."</td>";
                                echo "<td>".$results['patient']."</td>";
                                echo'<td><a class = "btn btn-primary" href="viewdoctors.php?id='.$results['id'].'">Read</a>';
                                echo"&nbsp&nbsp&nbsp";
                                echo"&nbsp&nbsp&nbsp";
                                echo'<a class = "btn btn-default" href="docupdate.php?id='.$results['id'].'">Update</a>';
