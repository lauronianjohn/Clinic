 ...
 elseif($user->docisloggedin()){
    $user->redirect("docdashboard.php");
...
<div class="col-sm-6">
    ...
    <div class="form-group">
            <label class="col-sm-4 control-label">Contact :</label>
                <div class="col-sm-8">
                    <input type="text" name="cont" class="form-control" placeholder="Contact" required>
                </div>
        </div>
    ...
    <div class="form-group">
            <label class="col-sm-4 control-label">Address :</label>
                <div class="col-sm-8">
                    <textarea rows="1" cols="1" name="add" class="form-control" placeholder="Address" required> </textarea>
                </div>
        </div>
     ...
     <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-sm-offset-4 col-sm-1">
                <button type="submit" name="submit" class="btn btn-primary"><h4>Make an Appointment</h4></button>
            </div>
        </div>
...
<div class="col-sm-6 ">
                            ...
                            <form name="contact-form" method="post">
                                ...
                                <div class="form-group">
                                    <textarea name="message" class="form-control" rows="11" placeholder="Message" required></textarea>
                                </div>
                               <button type="submit" name="send" class="btn btn-primary"><h4>Send Message</h4></button>
                            </form>
                        </div>
